            ...
            for box in boxes:
                if labels[box.get_label()] == 'charm':
                    ...
                    if box.get_score() < .50:
                        ...
                        skillshot_count += 1 
                        wait_i = frame_i+int(4*30) 

    if skillshot_name == 'orb':
        if frame_i > wait_i:
            ...
            for box in boxes:
                if labels[box.get_label()] == 'orb of deception':
                    ...
                    if box.get_score() < .50:
                        ...
                        print('1',frame_i,wait_i)

                        skillshot_count += 1 
                        wait_i = frame_i+int(4*30) 
                        print('2',frame_i,wait_i)


    return skillshot_count,wait_i
                        
def draw_boxes(image, boxes, labels):
    #test to see if it is even predicting... 
